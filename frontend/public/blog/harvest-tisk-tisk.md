...
My parents run a software testing + consulting company. They’ve been doing it for 17 years. They’re stable, they’re good at what they do, and their business is not complicated:

Good people --> startup clients --> track time --> invoice --> repeat.
...
We were paying **$9.99 USD per seat**. Then the quote came back with **$17.50 per seat**, plus a new “usage” layer where the options were either:
...
I spun up **Kimai**, an open source time tracking alternative, on our home server.
...
And **the weirdest part**: if we took the usage-based option, we’d have to enable **credit card billing on all invoices**. Translation: route more of the company’s money flow through Harvest's Stripe integration, and potentially hand over **+3%** of invoice revenue in processing/platform fees.
...
- On a homelab: basically **free** (already paying for power + internet + old pc's and already bought hardware)
...
For **$28,000** you could hire someone to build a full height rack, setup all the saas and IT services you could dream of, and still have enough money left over to buy 16gb of ddr5 for your gaming pc.
...
## My theory: this is the private equity playbook (and it backfires)
...
A pretty common term people use for this is **asset stripping**, extracting value (cash, fees, whatever) and leaving the company weaker on the other side. I theorize a version of this is happening over at Harvest right now. In extreme scinarios, the company dies as a result. The recent Hudson's Bay bankcruptcy is a good example of this process. A 356 year old company, one that shaped the fabric of Canadian nationhood, obliterated in 2 years of private equity management.

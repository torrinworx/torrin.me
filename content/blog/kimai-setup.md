---
title: Kimai time tracker setup guide.
description: A quick, copy-paste Docker Compose setup for running Kimai with a MySQL backend. It walks you through creating a `.env`, launching the stack, and getting Kimai reachable on port `8001`.
